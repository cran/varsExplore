...
You can also opt to use `View()` instead of the Viewer Pane, which works much faster than `DT::datatable()`, although, given how RStudio works, this makes it impossible to see both the variable explorer and your script at the same time.
